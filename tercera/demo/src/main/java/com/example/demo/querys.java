...
public class querys {
	...
	public static final String query1 ="Select t.segmento as segmento, t.cant as cant from ( "
	...
	public static final String query2 ="Select t.segmento as segmento, t.cant as cant, t.dep_id as dep_id from ( "
	...
	public static final String query3 = "select e.EMPLOYEE_ID as EMPLOYEE_ID, "
	...
	public static final String query4 = "select e.EMPLOYEE_ID as EMPLOYEE_ID, "
			+ " e.FIRST_NAME as FIRST_NAME, "
			+ " e.LAST_NAME as LAST_NAME, "
			+ " e.EMAIL as EMAIL, "
			+ " e.PHONE_NUMBER as PHONE_NUMBER, "
	...
	public static final String query5 = "select * "
	...
	public static final String query6 = "select count(1) as cantidad_empleados,  "
